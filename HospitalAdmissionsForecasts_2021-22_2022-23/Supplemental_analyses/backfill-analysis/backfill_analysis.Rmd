...
figures3a <- diffdf %>% filter(location_name != "US") %>% 
  ...
  labs(x = "Difference", y = "", title = "Supplementary Figure 3: state-specific distributions of absolute (panel a) and \nrelative changes (panel b) in HHS-Protect reported hospitalizations as of the \ninitial report date and the final evaluation date. ", caption = "10")+
  theme_bw()+
  facet_grid(cols = vars(season))

figures3a

ggsave(plot = figures3a,  paste0(manuscript_repo,"/Supplemental_analyses/Supplemental Output/Figure_S3a.pdf"), width = 8, height = 10)
...
ggsave(plot = figures3b, paste0(manuscript_repo,"/Supplemental_analyses/Supplemental Output/Figure_S3b.pdf"), width = 8, height = 10.1, dpi = 300)
