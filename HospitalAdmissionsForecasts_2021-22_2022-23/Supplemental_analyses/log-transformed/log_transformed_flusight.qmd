...
# jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Forecasts_and_observed_2021-2022.jpg"), width=10, height=8, units="in", res=300)
# print(fig21ln)
# dev.off()
# jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Forecasts_and_observed_2022-2023.jpg"), width=10, height=8, units="in", res=300)
# print(fig23ln)
# dev.off()


#ggsave(paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Forecasts_and_observed_2021-2022.png"), plot = fig21ln, width=10, height=8)


#ggsave(paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Forecasts_and_observed_2022-2023.png"), plot = fig23ln, width=10, height=8)
...
# 
# lg 
jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Abs_WIS_States_1and4week_figure_all.jpg"), width=8, height=5, units="in", res=300)
print(g)
dev.off()

 # ggsave(paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Log_WIS_States_1and4week_figure_all.png"), plot = lg, width = 8, height = 5)
```
...
jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Coverage_95_States_1and4week_figure_all.jpg"), width=8, height=5, units="in", res=300)
print(z)
dev.off()
...
y
#
jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Coverage_50_States_1and4week_figure_all.jpg"), width=8, height=5, units="in", res=300)
print(y)
dev.off()
```
##### Coverage Tables
...
# p2
# # 
# jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/model-ranksA.jpg"), width=8, height=5, units="in", res=300)
# print(p2)
# dev.off()
...
p2 <- inc_scores_overall %>% 
 ...
 p2
# # 
# jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/model-ranks_allcols.jpg"), width=8, height=8, units="in", res=300)
# print(p2)
# dev.off()
 # 
 # ggsave(paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/model-ranks_allcols.png"), width=8, height=8, units="in", plot = p2)
...
x
 ...
 #ggsave(plot = x, paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/Ave_4wk_WIS_model.png"), height = 6, width = 8)
```
...
# 
# jpeg(file = paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/WIS_scores_Boxplot.jpg"), width=10, height=8, units="in", res=300)
# print(u)
# dev.off()
# 
#ggsave(paste0(manuscript_repo, "/Supplemental_analyses/Supplemental Output/WIS_scores_Boxplot.png"), plot = u, width=10, height=8)
```