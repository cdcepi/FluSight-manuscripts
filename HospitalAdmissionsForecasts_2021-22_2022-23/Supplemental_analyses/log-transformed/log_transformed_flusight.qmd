...
#| warnings: false
#update
#source(paste0(dashboard_r_code_weekly_data,"WIS_calculation_function.R"))
...
#| 
  ...
  #   #datatable()
  #   arrange(`Relative WIS`) %>% mutate_if(is.numeric, round, digits = 2) %>%  knitr::kable(align = c("lcccccccccc"), caption = "Table 1 A) 2021-2022",
  #                                                                                          #col.names = c()
  #   ) %>% 
  #   kableExtra::footnote( general_title = "")%>% 
  #   kableExtra::kable_classic() %>% 
  #    kableExtra::kable_classic() %>% kableExtra::save_kable(file = paste0(dashboard_r_code,"/table1a.pdf"))
  # 
    
  # inc.rankings_all23ln %>%
  #   rename(Model = model,
  #          `Absolute WIS` = mean.WIS,
  #          `Relative WIS`= rel.WIS.skill,
  #          `50% Coverage (%)` = Percent.Cov.50,
  ...
  #          `% of Forecasts Submitted`) %>%
  #   #datatable()
  #   arrange(`Relative WIS`) %>% mutate_if(is.numeric, round, digits = 2) %>%  knitr::kable(align = c("lcccccccccc"), caption = "Table 1 B) 2022-2023",#col.names = c()
  #   ) %>% 
  #   kableExtra::footnote( general_title = "") %>% 
  #   kableExtra::kable_classic() # %>% kableExtra::save_kable(file = paste0(dashboard_r_code,"/table1b.pdf"))#, zoom = .6
...
#     
#   log_transformedtable1 <- inc.rankings_all %>%
#     rename(Model = model,
#            `Absolute WIS` = mean.WIS,
#            `Relative WIS`= rel.WIS.skill,
#            `50% Coverage (%)` = Percent.Cov.50,
...
# 
# write.csv(log_transformedtable1, paste0(dashboard_r_code,"/2022-23/supplemental_log-transformed/logtable1.csv"), row.names = FALSE)
#     
#     
...
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Forecasts_and_observed_2021-2022.jpg"), width=10, height=8, units="in", res=300)
# print(fig21ln)
# dev.off()
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Forecasts_and_observed_2022-2023.jpg"), width=10, height=8, units="in", res=300)
# print(fig23ln)
# dev.off()


#ggsave(paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Forecasts_and_observed_2021-2022.png"), plot = fig21ln, width=10, height=8)


#ggsave(paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Forecasts_and_observed_2022-2023.png"), plot = fig23ln, width=10, height=8)
...
#   labs(y = "Log Transformed Absolute WIS",
#        x = "Forecast Target End Date",
#        color = "Model",
#        title = "Log Transformed Absolute WIS by Model") +
#   theme_bw()+
...
# 
# lg 
jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Abs_WIS_States_1and4week_figure_all.jpg"), width=8, height=5, units="in", res=300)
print(g)
dev.off()

 # ggsave(paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard r Code/2022-23/supplemental_log-transformed/Log_WIS_States_1and4week_figure_all.png"), plot = lg, width = 8, height = 5)
```
...
jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Coverage_95_States_1and4week_figure_all.jpg"), width=8, height=5, units="in", res=300)
print(z)
dev.off()
...
y
#
jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Coverage_50_States_1and4week_figure_all.jpg"), width=8, height=5, units="in", res=300)
print(y)
dev.off()
```
##### Coverage Tables
...
# cov95_breakdown21ln %>% arrange(Relative_WIS) %>% mutate_if(is.numeric, round, digits = 2) %>%  knitr::kable(align = c("lcccccccccc"), caption = "Table 2 A", col.names = c("Model", "Relative WIS", "% WIS Below Baseline", "1 Wk Coverage", "2 Wk Coverage", "3 Wk Coverage", "4 Wk Coverage", "% Cov abv 90 (1 Wk)", "% Cov abv 90 (2 Wk)", "% Cov abv 90 (3 Wk)", "% Cov abv 90 (4 Wk)")) %>% 
#   kableExtra::footnote(general = "Table 2 A: % WIS Below Baseline shows the percent of WIS values for each model below the corresponding FluSight-Baseline WIS. The '% Cov abv 90' columns show the percent of weekly 95% coverage values that are greater than or equal to 90% for each model by horizon.", general_title = "")%>% 
#   kableExtra::kable_classic()# %>% 
#   #kableExtra::save_kable(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-2023/","Covtable2a.pdf"))

cov95_breakdown23ln <- cov95_function(WIS_Season23ln, Scores_tab23ln)

# cov95_breakdown23ln %>% arrange(Relative_WIS) %>% mutate_if(is.numeric, round, digits = 2) %>%  knitr::kable(align = c("lcccccccccc"), caption = "Table 2 B", col.names = c("Model", "Relative WIS", "% WIS Below Baseline", "1 Wk Coverage", "2 Wk Coverage", "3 Wk Coverage", "4 Wk Coverage", "% Cov abv 90 (1 Wk)", "% Cov abv 90 (2 Wk)", "% Cov abv 90 (3 Wk)", "% Cov abv 90 (4 Wk)")) %>% 
#   kableExtra::footnote(general = "Table 2 B: % WIS Below Baseline shows the percent of WIS values for each model below the corresponding FluSight-Baseline WIS. The '% Cov abv 90' columns show the percent of weekly 95% coverage values that are greater than or equal to 90% for each model by horizon.", general_title = "")%>% 
#   kableExtra::kable_classic()# %>% 
#   #kableExtra::save_kable(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-2023/","Covtable2b.pdf"))
...
cov95_breakdownall %>% arrange(season, Relative_WIS) %>% mutate_if(is.numeric, round, digits = 2) %>% select(-season) %>%  
  ...
  kableExtra::kable_classic() # %>% 
  # kableExtra::save_kable(file = paste0(dashboard_r_code,"/2022-23/supplemental_log-transformed/table2b.pdf"))
...
# abs_breakdown_WIS21ln <- merge( inc.rankings_all21ln[,c(1,3)],abs_breakdown[abs_breakdown$season == "2021-2022",], by = "model") %>% arrange(rel.WIS.skill)
# abs_breakdown_WIS23ln <- merge( inc.rankings_all23ln[,c(1,3)],abs_breakdown[abs_breakdown$season == "2022-2023",], by = "model") %>% arrange(rel.WIS.skill)
...
# 
# p2 <- inc_scores_overall %>% filter(season == "2021-2022") %>% 
...
# p2
# # 
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/model-ranksA.jpg"), width=8, height=5, units="in", res=300)
# print(p2)
# dev.off()
...
p2 <- inc_scores_overall %>% 
 ...
 p2
# # 
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/model-ranks_allcols.jpg"), width=8, height=8, units="in", res=300)
# print(p2)
# dev.off()
 # 
 # ggsave(paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/model-ranks_allcols.png"), width=8, height=8, units="in", plot = p2)
...
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/WIS_scores_Location_all.jpg"), width=12, height=8, units="in", res=300)
# print(fig_wis_loc)
# dev.off()
# 
#ggsave(paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/logWIS_scores_Location_all.png"), plot = fig_wis_loc, width = 12, height= 8)
...
x
 ...
 #ggsave(plot = x, paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/Ave_4wk_WIS_model.png"), height = 6, width = 8)
```
...
# 
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/WIS_scores_Boxplot.jpg"), width=10, height=8, units="in", res=300)
# print(u)
# dev.off()
# 
#ggsave(paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/supplemental_log-transformed/WIS_scores_Boxplot.png"), plot = u, width=10, height=8)
```