...
##Observed Data
obs_data21 <- read_csv(paste0(flusight_forecast_data,"/truth-Incident Hospitalizations-Archived_9-12-2022.csv")) %>%
...
logtable1 <- read.csv(paste0(manuscript_repo,"/Supplemental_analyses/Supplemental Output/logtable1.csv")) 
