...
#this can only be run after the supplemental log transformed analysis 
...
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/Forecasts_and_observed_2021-2022.jpg"), width=10, height=8, units="in", res=300)
# print(fig21)
# dev.off()
# jpeg(file = paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/Forecasts_and_observed_2022-2023.jpg"), width=10, height=8, units="in", res=300)
# print(fig23)
# dev.off()
...
cov95_breakdownall %>% arrange(season, Relative_WIS) %>% mutate_if(is.numeric, round, digits = 2) %>% select(-season) %>%  
  ...
  # kableExtra::save_kable(file = paste0(dashboard_r_code,"/2022-23/table2b.pdf"))
...
wklyplt
# 
# ggsave(plot = wklyplt, paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/backfill_epicurv_mon_tue.png"), height = 6, width = 8, dpi = 300)
```
...
absoplt
 ...
 # ggsave(plot = absoplt,  paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/Numeric_difference_all.png"), width = 6, height = 8, dpi = 300)
...
# ggsave(plot = percplt, paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/Percent_difference_all.png"), width = 6, height = 8, dpi = 300)
...
# 
# ggsave(plot = stairplt21,  paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/stairstep21.png"), width = 8, height = 6, dpi = 300)
# ggsave(plot = stairplt23,  paste0("C:/Users/",userid,"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/2022-23/stairstep23.png"), width = 12, height = 8, dpi = 300)
...
### Observed Data percent change week-to-week
```
